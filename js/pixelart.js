...
// Front views — used for ONCOMING traffic (Wrong Way Express). Headlights (f) at the
// outer corners, grille toward the centre, windscreen up top. Half-grids (left half).
const PX_CAR_F = [
  '...kkkkkkk',
  '..k1111111',
  '.k11gggggg',
...
// ============================ TIER 3: POLICE (superbike + siren) ============================
// A superbike underneath: white bodywork (col 1), black accents (col 3), with a
// red-over-blue beacon (x/d) on the tail. Rear is a half-grid; the beacon sits centre.
const PX_POLICE = [
  '........kk',
  '......khhh',
  '.....khhhh',
...
// Side view (full grid, riderless) — beacon (x red, d blue) on the rear cowl.
const PXS_POLICE = [
  '....kkkkk...................',
  '...k3xd33k..................',
  '...k333331kkkkk.............',
...
PX_PLAYER.police = [PX_POLICE]; PXS_PLAYER.police = [PXS_POLICE];

// ============================ THE CROSSING GUARD ============================
// School Run static hazard: hi-vis vest, cap, STOP sign held high. Full grid.
const PX_GUARD = [
  '..........xx..',
  '.........xxxx.',
  '.........xwwx.',
...
// ============================ TIER 3: TRIKE (half grid, extra wide) ============================
const PX_TRIKE = [
  '...........kk',
  '.........khhh',
  '........khhhh',
...
const PXS_TRIKE = [
  ...
  '....k111111111111kkk........',
  '.....k11111111111111kgk.....',
  '....k1111111111111111ggk....',
  '...k11111kkkk111111111kk....',
  '..k11111kk..kk111111111fk...',
  '..k111kk......kk1111kkkk....',
  '...kkkk.......k111kkk.......',
  '.kttttttk.....kkkttttk......',
  'kttTtTttk.......kttTttk.....',
...
// ============================ TIER 3: DUNE BUGGY (roll cage, knobby tires) ============================
const PX_BUGGY = [
  '...k333333333',
  '..k3k........',
  '..k3k....kkkk',
...
const PXS_BUGGY = [
  ...
  '...k111111111111113k........',
  '..k11111111111111111k.......',
  '..k1111kkkk111111111kfk.....',
  '..k111kk..kk11111111kkk.....',
  '...kkkk....kk1111kkkk.......',
  '..kTtTtk.....kkkTtTtk.......',
  '.kTtTtTtk......kTtTtTtk.....',
  '.ktT33Ttk......ktT33Ttk.....',
...
// ============================ TIER 3: STEAMPUNK (twin stacks, brass boiler) ============================
const PX_STEAM = [
  '.kAk......',
  '.kAk......',
  '.kAk..khhh',
...
const PXS_STEAM = [
  ...
  '...k333331kkkkkAAkkk........',
  '....k111111111111111kgk.....',
  '...k11113333111111111gk.....',
  '..k11111kkkk3311111111kk....',
  '..k1111kk..kk331111111kfk...',
  '..k111kk....kk11111kkkkk....',
  '....kkk......k111kkk........',
  '..kttttk.....kkkttttk.......',
  '.kttTtttk......kttTtttk.....',
